            ...
            <div class="card-inner" style="padding:var(--space-10)">
              ...
              <div class="form-group">
                ...
                <div class="input-icon-wrapper">
                  ...
                  <input class="form-input" id="rp-pwd" type="password" placeholder="Min. 8 characters" autocomplete="new-password" maxlength="128" required 
                    oninput="updateStrength(this.value)" />
                  <span class="input-icon-right" onclick="togglePwd('rp-pwd')" role="button" aria-label="Toggle password visibility">👁</span>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="input-icon-wrapper">
                  <span class="input-icon">🔒</span>
                  <input class="form-input" id="rp-confirm" type="password" placeholder="Repeat password" autocomplete="new-password" maxlength="128" required
              ...
              <div class="auth-link-row">
                <a href="#" onclick="Router.go('/login');return false;" style="color:var(--clr-primary)">← Back to Sign In</a>
              </div>
            </div>
          </div>
        </div>
